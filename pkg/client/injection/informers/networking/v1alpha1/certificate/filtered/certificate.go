...
func Get(ctx context.Context, selector string) v1alpha1.CertificateInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/networking/pkg/client/informers/externalversions/networking/v1alpha1.CertificateInformer with selector %s from context.", selector)
	}
