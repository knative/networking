...
import (
	...
	domain "knative.dev/networking/pkg/client/injection/reconciler/networking/v1alpha1/domain"
...
//var _ domain.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ domain.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.Domain) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.Domain) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
