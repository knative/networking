...
import (
	...
	realm "knative.dev/networking/pkg/client/injection/reconciler/networking/v1alpha1/realm"
...
//var _ realm.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ realm.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.Realm) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.Realm) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
